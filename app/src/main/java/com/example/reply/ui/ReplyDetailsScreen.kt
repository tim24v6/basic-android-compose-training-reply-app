...
fun ReplyDetailsScreen(
    ...
    // when the user is at the details screen, tapping back system button ends of the app,
    // Reply app doesn't use a NavHost, you have to add the code to handle the back button manually.
    BackHandler {
        onBackPressed()
    }
